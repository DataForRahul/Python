...
Welcome to the ATM Machine Simulator project! This project simulates basic ATM operations, such as checking balance, withdrawing money, 
depositing money, and changing the PIN.
...
Initial Setup 
User Class: Created a User class such as PIN, balance, and name. This class includes methods to update the balance and PIN.
